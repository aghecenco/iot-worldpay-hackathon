...
class Service(object):
    ...
    thrift_spec = (
        ...
        (4, TType.STRING, 'serviceType', 'UTF8', None, ),  # 4
        (5, TType.MAP, 'prices', (TType.I32, None, TType.STRUCT, (Price, Price.thrift_spec), False), None, ),  # 5
    )

    def __init__(self, id=None, name=None, description=None, serviceType=None, prices=None,):
        self.id = id
        self.name = name
        self.description = description
...
class ServiceMessage(object):
    ...
    thrift_spec = (
        ...
        (8, TType.SET, 'serviceTypes', (TType.STRING, 'UTF8', False), None, ),  # 8
    )

    def __init__(self, deviceDescription=None, hostname=None, portNumber=None, serverId=None, urlPrefix=None, scheme=None, deviceName=None, serviceTypes=None,):
    ...
    def write(self, oprot):
        ...
        if self.deviceName is not None:
            ...
            oprot.writeFieldEnd()
        if self.serviceTypes is not None:
            oprot.writeFieldBegin('serviceTypes', TType.SET, 8)
            oprot.writeSetBegin(TType.STRING, len(self.serviceTypes))
            for iter24 in self.serviceTypes:
